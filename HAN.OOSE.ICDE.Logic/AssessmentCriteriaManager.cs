...
{
    public class AssessmentCriteriaManager : VersionedEntityManager<Domain.AssessmentCriteria, Persistency.Database.Domain.AssessmentCriteria, IAssessmentCriteriaRepositorySession>
    {
